      ...
      <div className="flex-1/2 md:space-y-6 space-y-4  max-w-[608px]">
        ...
        <div className="md:space-y-4 space-y-2">
          <div className="flex gap-4 items-center space-y-1">
            <div className="md:size-16 size-12 rounded-full border-4 border-white shadow-header bg-green-500 overflow-hidden flex shrink-0">
              <img
                src="./stokes.png"
                alt="image"
                className="md:h-16 h-12 object-cover "
              />
            </div>
            <div>
              <h6 className="text-lg md:text-2xl text-green-400 font-bold">
                Spenser Stokes
              </h6>
              <p className="text-dark-gray text-sm md:text-lg">
                Professional Fitness Trainer
              </p>
            </div>
          </div>
          <p className="text-sm md:text-xl text-green-300">
            Kickstart your exciting fitness journey today! Join us as we guide
            you through a dynamic daily workout plan tailored just for you.
          </p>
        </div>
      </div>
      <div className="flex-1/2 md:space-y-6 space-y-4 max-w-[608px]">
