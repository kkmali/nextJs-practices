...
export default function DashboardHeader() {
  return (
    <>
      <section className="md:sticky md:16 lg:top-[100px] md:z-[9] ">
        <div className="-mt-6 pt-0 pb-[210px] sm:pb-[220px] xl:pb-28 xl:pt-12 bg-green-600 text-white rounded-b-2xl md:rounded-b-[20px]">
